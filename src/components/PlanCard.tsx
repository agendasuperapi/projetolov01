...
export default function PlanCard({
  ...
  return (
    <Card className={`relative overflow-hidden transition-all duration-500 ease-out animate-scale-fade-in hover:shadow-2xl hover:-translate-y-2 bg-white dark:bg-card border-0 shadow-xl w-[calc(50%-0.5rem)] lg:w-[calc(25%-0.75rem)] max-w-[280px] ${isDisabled ? 'opacity-60' : ''} ${hasCouponDiscount ? 'ring-2 ring-emerald-500 shadow-emerald-500/30 scale-[1.02]' : ''}`}>
      {/* Coupon indicator */}
      {hasCouponDiscount && (
